...
/* ******************************************************************** */
void   *
DFEF_calloc(int num_elem, int elem_size, const char *comment)
{
...
/* ******************************************************************** */
void   *
DFEF_malloc(int num_bytes, const char *comment)
{
  void   *ptr;
...
/* ******************************************************************** */
void   *
DFEF_free_then_malloc(void *ptr, int num_bytes, const char *comment)
{
  if (defDebug[1])
...
/* ******************************************************************** */
void   *
DFEF_realloc(void *ptr, int num_bytes, const char *comment)
{
  if (defDebug[1])
...
/* ******************************************************************** */
void   *
DFEF_relax(void *ptr, int num_bytes, const char *comment)
{
  void   *old_ptr;
...
/* ******************************************************************** */
void 
DFEF_free(void *ptr, const char *comment)
{
  if (defDebug[1])
