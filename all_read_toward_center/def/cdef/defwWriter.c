 ...
 * Rosa *//* Date:   Summer, 1998 *//* Revisions: 11/25/2002 - bug fix:
 * submitted by Craig Files *//* (cfiles@ftc.agilent.com) *//* Changed all
...
int     defwFPC = 0;		/* Current number of items in
				 * constraints/operand/sum */
...
static int defwBlockageHasSD = 0;	/* keep track only
					 * Spacing|Designrulewidth */
char    defwStateStr[MAXSYN][80] = {"UNINITIALIZE", /* 0 */ "INITIALIZE", /* 1 */ "VERSION", /* 2 */ "CASESENSITIVE", /* 3 */ "BUSBIT", /* 4 */ "DIVIDER", /* 5 */ "DESIGN", /* 6 */ "TECHNOLOGY", /* 7 */ "ARRAY", /* 8 */ "FLOORPLAN", /* 9 */ "UNITS", /* 10 */ "HISTORY", /* 11 */ "PROPERTYDEFINITIONS", /* 12 */ "PROPERTYDEFINITIONS", /* 13 */ "PROPERTYDEFINITIONS", /* 14 */ "DIEAREA", /* 15 */ "ROW", /* 16 */ "TRACKS", /* 17 */ "GCELLGRID", /* 18 */ "DEFAULTCAP", /* 19 */ "DEFAULTCAP", /* 20 */ "DEFAULTCAP", /* 21 */ "CANPLACE", /* 22 */ "CANNOTOCCUPY", /* 23 */ "VIA", /* 24 */ "VIA", /* 25 */ "VIA", /* 26 */ "VIA", /* 27 */ "VIA", /* 28 */ "REGION", /* 29 */ "REGION", /* 30 */ "REGION", /* 31 */ "COMPONENT", /* 32 */ "COMPONENT", /* 33 */ "COMPONENT", /* 34 */ "PIN", /* 34 */ "PIN", /* 36 */ "PIN", /* 37 */ "PIN", /* 38 */ "PINPROPERTY", /* 39 */ "PINPROPERTY", /* 40 */ "PINPROPERTY", /* 41 */ "SNET", /* 42 */ "SNET", /* 43 */ "SNET", /* 44 */ "SNET", /* 45 */ "SNET", /* 46 */ "PATH", /* 47 */ "PATH", /* 48 */ "SHIELD", /* 49 */ "NET", /* 50 */ "NET", /* 51 */ "NET", /* 52 */ "NET", /* 53 */ "NET", /* 54 */ "SUBNET", /* 55 */ "NOSHIELD", /* 56 */ "IOTIMING", /* 57 */ "IOTIMING", /* 58 */ "IOTIMING", /* 59 */ "SCANCHAIN", /* 60 */ "SCANCHAIN", /* 61 */ "SCAN FLOATING", /* 62 */ "SCAN ORDERED", /* 63 */ "SCANCHAIN", /* 64 */ "CONSTRAINTS", /* 65 */ "CONSTRAINTS", /* 66 */ "CONSTRAINTS", /* 67 */ "CONSTRAINTS", /* 68 */ "CONSTRAINTS", /* 69 */ "GROUP", /* 70 */ "GROUP", /* 71 */ "GROUP", /* 72 */ "BLOCKAGE", /* 73 */ "BLOCKAGE LAYER", /* 74 */ "BLOCKAGE PLACEMENT", /* 75 */ "BLOCKAGE RECT", /* 76 */ "BLOCKAGE POLYGON", /* 77 */ "BLOCKAGE", /* 78 */ "SLOT", /* 79 */ "SLOT", /* 80 */ "SLOT", /* 81 */ "SLOT", /* 82 */ "FILL", /* 83 */ "FILL", /* 84 */ "FILL", /* 85 */ "FILL", /* 86 */ "FILL", /* 87 */ "FILL", /* 88 */ "NDR", /* 89 */ "NDR", /* 90 */ "NDR", /* 91 */ "STYLES", /* 92 */ "STYLES", /* 93 */ "STYLES", /* 94 */ "BEGINEXT", /* 95 */ "BEGINEXT", /* 96 */ "BEGINEXT", /* 97 */ "DESIGN END", /* 98 */ };
 ...
 *//* sections. *//* Either this function or defwInitCbk can be called, cannot
    be both */ int 
defwInit(FILE * f,
	 int vers1, int vers2,
...
)
{
  ...
  /*
   * don't need anymore if (!defiValidUser()) exit(77);
   */

  /*
   * (defwFile) return DEFW_BAD_ORDER;
   */ defwFile = f;
  if (defwHasInitCbk == 1) {	/* defwInitCbk has already called, issue an
				 * error */
    fprintf(stderr,
 ...
 *//* Either this function or defwInit can be called, cannot be both */ int 
defwInitCbk(FILE * f)
{
  defwFile = f;
  if (defwHasInit == 1) {	/* defwInit has already called, issue an
				 * error */
    fprintf(stderr,
...
int 
defwVersion(int vers1, int vers2)
{
...
int 
defwStringProperty(const char *propName, const char *propValue)
{
  if (!defwIsPropState())
    return DEFW_BAD_ORDER;
   ...
   *//* do not end with newline, may have more than on properties */ fprintf(defwFile, "\n + PROPERTY %s \"%s\" ", propName, propValue);
  defwLines++;
  return DEFW_OK;
}

int 
defwRealProperty(const char *propName, double propValue)
{
  if (!defwIsPropState())
    return DEFW_BAD_ORDER;
...
int 
defwIntProperty(const char *propName, int propValue)
{
  if (!defwIsPropState())
    return DEFW_BAD_ORDER;
...
int 
defwDieArea(int xl, int yl, int xh, int yh)
{
...
int 
defwDieAreaList(int num_points, int *xl, int *yl)
{
  int     i;
...
int 
defwRow(const char *rowName, const char *rowType,
	...
	int do_x, int do_y)
{
  ...
  if (defwState == DEFW_ROW)
    fprintf(defwFile, ";\n");	/* add the ; and newline for the previous
   * row. *//* required */
   ...
   *//* do not end with newline, if there is no property, ; need to be concat. */ fprintf(defwFile, "ROW %s %s %d %d %s ", rowName, rowType, x_orig, y_orig,
							defwOrient(orient));
...
int 
defwRowStr(const char *rowName, const char *rowType,
	   int x_orig, int y_orig,
	   const char *orient,
	   int do_count, int do_increment,
	   int do_x, int do_y)
...
int 
defwTracks(const char *master, int do_start,
...
int 
defwGcellGrid(const char *master, int do_start,
...
int 
defwDefaultCap(int pins, double cap)
{
...
int 
defwCanPlace(const char *master, int xOrig, int yOrig,
...
int 
defwCanPlaceStr(const char *master, int xOrig, int yOrig,
...
int 
defwCannotOccupy(const char *master, int xOrig, int yOrig,
		 int orient, int doCnt, int doInc, int xStep, int yStep)
{
...
int 
defwCannotOccupyStr(const char *master, int xOrig, int yOrig,
	     const char *orient, int doCnt, int doInc, int xStep, int yStep)
{
  defwFunc = DEFW_CANNOTOCCUPY;	/* Current function of writer */
  if (!defwFile)
...
defwViaPattern(const char *pattern)
{
  ...
  if (defwViaHasVal)
    return DEFW_ALREADY_DEFINED;/* either PatternName or *//* ViaRule has
				 * defined */
...
int 
defwViaRect(const char *layerNames, int xl, int yl, int xh, int yh)
{
  defwFunc = DEFW_VIA;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwViaViarule(const char *viaRuleName, double xCutSize, double yCutSize,
...
int 
defwViaViaruleRowCol(int numCutRows, int numCutCols)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwViaViaruleOrigin(int xOffset, int yOffset)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_VIAVIARULE)
...
int 
defwViaViaruleOffset(int xBotOffset, int yBotOffset,
...
int 
defwRegionPoints(int xl, int yl, int xh, int yh)
{
  defwFunc = DEFW_REGION;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwComponent(const char *instance, const char *master,
...
int 
defwComponentStr(const char *instance, const char *master,
		 int numNetName, const char **netNames, const char *eeq,
		 const char *genName, const char *genParemeters,
		 const char *source, int numForeign, const char **foreigns,
...
int 
defwComponentHalo(int left, int bottom, int right, int top)
{
  defwFunc = DEFW_COMPONENT;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
 ...
 * 5.7
 */ int 
defwComponentHaloSoft(int left, int bottom, int right, int top)
{
  defwFunc = DEFW_COMPONENT;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
 ...
 * 5.7
 */ int 
defwComponentRouteHalo(int haloDist, const char *minLayer,
		       const char *maxLayer)
{
  defwFunc = DEFW_COMPONENT;	/* Current function of writer */
  if (!defwFile)
...
int 
defwPin(const char *name, const char *net,
...
int 
defwPinStr(const char *name, const char *net,
	   int special,		/* optional 0-ignore 1-special  */
	   const char *direction,	/* optional  */
	   const char *use,	/* optional  */
...
int 
defwPinLayer(const char *layerName, int spacing, int designRuleWidth,
	     int xl, int yl, int xh, int yh)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  ...
  if (spacing && designRuleWidth)
    return DEFW_BAD_DATA;	/* only one, spacing *//* or designRuleWidth
...
int 
defwPinPolygon(const char *layerName, int spacing, int designRuleWidth,
	       int num_polys, double *xl, double *yl)
{
  int     i;
 ...
 * 5.7
 */ int 
defwPinVia(const char *viaName, int xl, int yl)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
 ...
 * 5.7
 */ int 
defwPinPortLayer(const char *layerName, int spacing, int designRuleWidth,
		 int xl, int yl, int xh, int yh)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
 ...
 * 5.7
 */ int 
defwPinPortPolygon(const char *layerName, int spacing, int designRuleWidth,
		   int num_polys, double *xl, double *yl)
{
  int     i;
 ...
 * 5.7
 */ int 
defwPinPortVia(const char *viaName, int xl, int yl)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN && defwState != DEFW_PIN_PORT)
 ...
 * 5.7
 */ int 
defwPinPortLocation(const char *status, int statusX, int statusY,
		    const char *orient)
{
  int     i;
...
int 
defwPinAntennaPinPartialMetalArea(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinAntennaPinPartialMetalSideArea(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinAntennaPinPartialCutArea(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinAntennaPinDiffArea(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinAntennaPinGateArea(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinAntennaPinMaxAreaCar(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinAntennaPinMaxSideAreaCar(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinAntennaPinMaxCutCar(int value, const char *layerName)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_PIN)
...
int 
defwPinProperty(const char *name, const char *pinName)
{
...
int 
defwSpecialNetConnection(const char *inst, const char *pin,
			 int synthesized)
{
  defwFunc = DEFW_SNET;		/* Current function of writer */
  if (!defwFile)
  ...
  if (defwState != DEFW_SNET)
    return DEFW_BAD_ORDER;
  if ((++defwLineItemCounter & 3) == 0) {	/* since a net can have more
						 * than */
...
int 
defwSpecialNetSpacing(const char *layer, int spacing, double minwidth,
		      double maxwidth)
{
  defwFunc = DEFW_SNET;		/* Current function of writer */
  if (!defwFile)
...
int 
defwSpecialNetWidth(const char *layer, int w)
{
  defwFunc = DEFW_SNET;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
/*
int 
defwSpecialNetNumberProperty(const char *name, double num)
{
  defwFunc = DEFW_SNET;		* Current function of writer *
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
/*
int 
defwSpecialNetStringProperty(const char *name, const char *value)
{
  defwFunc = DEFW_SNET;		* Current function of writer *
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
defwSpecialNetPathStart(const char *typ)
{
   ...
   *//* must start it with a new instead of a fixed... */ if (strcmp(typ, "NEW") == 0) {
...
int 
defwSpecialNetPathPoint(int numPts, const char **pointx,
			const char **pointy)
{
  int     i;
...
int 
defwSpecialNetPathViaData(int numX, int numY, int stepX, int stepY)
{
  defwFunc = DEFW_PATH;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwSpecialNetPathPointWithWireExt(int numPts, const char **pointx,
...
defwSpecialNetShieldStart(const char *name)
{
   ...
   *//* must start it with a new instead of the name ... */ if (strcmp(name, "NEW") == 0) {
...
int 
defwSpecialNetShieldPoint(int numPts, const char **pointx,
			  const char **pointy)
{
  int     i;
...
int 
defwSpecialNetShieldViaData(int numX, int numY, int stepX, int stepY)
{
  defwFunc = DEFW_SHIELD;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
defwEndSpecialNets()
{
  ...
  if (defwState != DEFW_SNET_START && defwState != DEFW_SNET_OPTIONS &&
      defwState != DEFW_SNET_ENDNET && /* last state is special net */ defwState != DEFW_SNET)
    return DEFW_BAD_ORDER;
  if (defwCounter > 0)
    return DEFW_BAD_DATA;
  else if (defwCounter < 0)
...
int 
defwNetConnection(const char *inst, const char *pin, int synthesized)
{
  defwFunc = DEFW_NET;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (defwState != DEFW_NET)
    return DEFW_BAD_ORDER;
  if ((++defwLineItemCounter & 3) == 0) {	/* since there is more than
						 * one */
...
int 
defwNetMustjoinConnection(const char *inst, const char *pin)
{
  defwFunc = DEFW_NET;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwNetVpin(const char *vpinName, const char *layerName, int layerXl,
...
int 
defwNetVpinStr(const char *vpinName, const char *layerName, int layerXl,
	       int layerYl, int layerXh, int layerYh, const char *status,
...
int 
defwNetNoshieldPoint(int numPts, const char **pointx,
		     const char **pointy)
{
  int     i;
...
int 
defwNetSubnetPin(const char *compName, const char *pinName)
{
  defwFunc = DEFW_SUBNET;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
defwNetSubnetEnd()
{
  ...
  if ((defwState != DEFW_SUBNET) &&	/* subnet does not have path  */
      (defwState != DEFW_NET_OPTIONS))	/* subnet has path and path just
					 * ended  */
    return DEFW_BAD_ORDER;
  defwState = DEFW_NET_OPTIONS;
  return DEFW_OK;
...
int 
defwNetPathLayer(const char *name, int isTaper, const char *ruleName)
{
  defwFunc = DEFW_PATH;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwNetPathPoint(int numPts, const char **pointx, const char **pointy,
		 const char **value)
{
  int     i;
...
int 
defwNetPathViaWithOrient(const char *name, int orient)
{
  defwFunc = DEFW_PATH;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwNetPathViaWithOrientStr(const char *name, const char *orient)
{
  defwFunc = DEFW_PATH;		/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwIOTiming(const char *instance, const char *pin)
{
...
int 
defwIOTimingVariable(const char *riseFall, int num1,
		     int num2)
{
  defwFunc = DEFW_IOTIMING;	/* Current function of writer */
  if (!defwFile)
...
int 
defwIOTimingSlewrate(const char *riseFall, int num1,
		     int num2)
{
  defwFunc = DEFW_IOTIMING;	/* Current function of writer */
  if (!defwFile)
...
int 
defwIOTimingDrivecell(const char *name, const char *fromPin,
...
int 
defwScanchainCommonscanpins(const char *inst1, const char *pin1,
...
int 
defwScanchainPartition(const char *name, int maxBits)
{
  defwFunc = DEFW_SCANCHAIN;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwScanchainStart(const char *inst, const char *pin)
{
  defwFunc = DEFW_SCANCHAIN;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwScanchainStop(const char *inst, const char *pin)
{
  defwFunc = DEFW_SCANCHAIN;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
		     ...
		     const char *inst4, const char *pin4)
{
  ...
  if (inst2 && !pin2)
    return DEFW_BAD_DATA;
  if (defwState != DEFW_SCAN_ORDERED) {	/* 1st time require both name1 &
					 * name2 */
...
int 
defwConstraintOperandPath(const char *comp1, const char *fromPin,
...
int 
defwConstraintOperandTime(const char *timeType, int time)
{
  defwFunc = DEFW_FPC_OPER;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwConstraintWiredlogic(const char *netName, int distance)
{
...
int 
defwGroup(const char *groupName, int numExpr, const char **groupExpr)
{
  int     i;
...
int 
defwGroupSoft(const char *type1, double value1, const char *type2,
...
int 
defwGroupRegion(int xl, int yl, int xh, int yh, const char *regionName)
{
  defwFunc = DEFW_GROUP;	/* Current function of writer */
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
defwBlockageSpacing(int minSpacing)
{
   ...
   */ if ((defwState != DEFW_BLOCKAGE_LAYER) && (defwState != DEFW_BLOCKAGE_RECT))
    return DEFW_BAD_DATA;
  if (defwBlockageHasSD)	/* Either spacing or designrulewidth has
				 * defined */
    return DEFW_BAD_DATA;
...
int 
defwBlockageRect(int xl, int yl, int xh, int yh)
{
...
int 
defwBlockagePolygon(int num_polys, double *xl, double *yl)
{
  int     i;
  ...
  defwLines++;
  defwState = DEFW_BLOCKAGE_RECT;	/* use rect flag.  It works the same
					 * for poly */
  return DEFW_OK;
}
...
int 
defwSlotRect(int xl, int yl, int xh, int yh)
{
...
int 
defwSlotPolygon(int num_polys, double *xl, double *yl)
{
  int     i;
...
int 
defwFillRect(int xl, int yl, int xh, int yh)
{
...
int 
defwFillPolygon(int num_polys, double *xl, double *yl)
{
  int     i;
...
int 
defwFillPoints(int num_points, double *xl, double *yl)
{
  int     i;
...
int 
defwNonDefaultRule(const char *ruleName, int hardSpacing)
{
  defwFunc = DEFW_NDR;
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwNonDefaultRuleLayer(const char *layerName, int width,
...
int 
defwNonDefaultRuleMinCuts(const char *cutLayerName, int numCuts)
{
  defwFunc = DEFW_NDR;
  if (!defwFile)
    return DEFW_UNINITIALIZED;
...
int 
defwStyles(int styleNums, int num_points, double *xp, double *yp)
{
  int     i;
...
int 
defwBeginextRevision(int vers1, int vers2)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (!defwDidInit)
...
int 
defwBeginextSyntax(const char *title, const char *string)
{
  if (!defwFile)
    return DEFW_UNINITIALIZED;
  if (!defwDidInit)
