		    ...
		    FILE * f)
{
  ...
  if (defiPartition_hasMin(this))
    fprintf(f, " MIN %g\n", defiPartition_partitionMin(this));
  if (defiPartition_hasMax(this))
    fprintf(f, " MAX %g\n", defiPartition_partitionMax(this));
...
double 
defiPartition_partitionMin(const defiPartition * this)
{
  return (this->min_);
}

double 
defiPartition_partitionMax(const defiPartition * this)
{
  return (this->max_);
}
