 ...
 * 5.7
 */ void 
lefiGeometries_addLayerExceptPgNet(lefiGeometries * this)
{
  int    *d = (int *) lefMalloc(sizeof(int));

  *d = 1;
  lefiGeometries_add(this,
		     (void *) d, lefiGeomLayerExceptPgNetE);
}
 ...
 * 5.7
 */ int 
lefiGeometries_hasLayerExceptPgNet(const lefiGeometries * this,
				   int index)
{
  char    msg[160];
		     ...
		     FILE * f)
{
  ...
  for (i = 0;
    ...
    case lefiGeomLayerExceptPgNetE:
      if (lefiGeometries_getLayerMinSpacing(this,
					    i))
    ...
    case lefiGeomClassE:
      ...
      break;
    default:
      lefiError("ERROR (LEFPARS-1375): unknown geometry type");
