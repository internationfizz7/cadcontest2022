...
/*
 * Not needed time_t defiCalcTime() { Calculate the number for the given date
 * The date is 5/1/99
 * 
 * Used to calculate the UTC for a time bomb date in libcai.a see caiInitWork()
 * function
 * 
 * struct tm	ts;
 * 
 * ts.tm_sec = 0; ts.tm_min = 0; ts.tm_hour = 0; ts.tm_mday = 1; ts.tm_mon = 5;
 * ts.tm_year = 1999 - 1900; ts.tm_wday = 0; ts.tm_yday = 0; ts.tm_isdst = 0;
 * 
 * 
...
/*
 * defiTimeBomb
 *//* Check the current date against the date given *//* int defiValidTime() {
 * time_t	bombTime = defiCalcTime(); time_t	curTime;
 * 
