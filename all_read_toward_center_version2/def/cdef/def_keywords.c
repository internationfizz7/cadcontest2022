...
#include "defiDebug.h"
void 
STR_add_to_stringtab_Int(void *hdl, const char *str, int inValue)
{
  int    *value;

  /*
   * Modified 9/2/99 -- Wanda da Rosa
   *//* need to free this in DFEF_stringhash.cpp */ value = (int *) defMalloc(sizeof(int));
  if (value != NULL) {
    *value = inValue;
...
void 
init_symbol_table(void *Keyword_set)
{
