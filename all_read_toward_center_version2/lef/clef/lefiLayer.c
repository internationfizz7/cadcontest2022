 ...
 * lefiTwoWidths
 */ lefiTwoWidths *
lefiTwoWidths_CreateUninitialized()
{
  lefiTwoWidths *this = (lefiTwoWidths *) malloc(sizeof(lefiTwoWidths));

  lefiTwoWidths_Init(this);
  return (this);
}

void 
lefiTwoWidths_Init(lefiTwoWidths * this)
{
  this->numWidth_ = 0;
  this->numWidthAllocated_ = 0;
}
...
void 
lefiTwoWidths_Destroy(lefiTwoWidths * this)
{
  if (this->numWidth_) {
    lefFree((char *) (this->width_));
...
void
lefiTwoWidths_Delete(lefiTwoWidths * this)
{
  if (this == NULL)
    return;
  lefiTwoWidths_Destroy(this);
  free(this);
}

void 
lefiTwoWidths_addTwoWidths(lefiTwoWidths * this,
			   double width,
			   double prl,
			   int numSpacing,
			   double *spacings)
{
  ...
  if (this->numWidth_ == this->numWidthAllocated_) {
    ...
    if (this->numWidth_ > 0) {
      nws = (double *) lefMalloc(sizeof(double) * (this->atNsp_[this->numWidth_ - 1] + numSpacing));
      for (i = 0;
	   i < this->atNsp_[this->numWidth_ - 1];
	   i++) {
	nws[i] = this->widthSpacing_[i];
      }
    }
...
int 
lefiTwoWidths_numWidth(const lefiTwoWidths * this)
{
  return this->numWidth_;
}

double 
lefiTwoWidths_width(const lefiTwoWidths * this,
		    int index)
{
  return this->width_[index];
}
...
int 
lefiTwoWidths_hasWidthPRL(const lefiTwoWidths * this,
			  int index)
{
...
double 
lefiTwoWidths_widthPRL(const lefiTwoWidths * this,
		       int index)
{
...
int 
lefiTwoWidths_numWidthSpacing(const lefiTwoWidths * this,
			      int index)
{
...
double 
lefiTwoWidths_widthSpacing(const lefiTwoWidths * this,
			   int iWidth,
			   int iWidthSpacing)
{
  if (iWidth == 0)
...
lefiSpacingTable_Destroy(lefiSpacingTable * this)
{
  ...
  if (this->twoWidths_) {
    lefiTwoWidths_Destroy(this->twoWidths_);
...
int 
lefiSpacingTable_isParallel(const lefiSpacingTable * this)
{
...
lefiTwoWidths *
lefiSpacingTable_twoWidths(const lefiSpacingTable * this)
{
 ...
 * 5.7
 */ void 
lefiSpacingTable_addTwoWidths(lefiSpacingTable * this,
			      double width,
			      double runLength,
			      int numSpacing,
			      double *spacings)
{
  ...
  if (this->twoWidths_ == 0) {
    ...
    lefiTwoWidths_Init(twoWidths);
    this->twoWidths_ = twoWidths;
  }
  else
    twoWidths = this->twoWidths_;
  lefiTwoWidths_addTwoWidths(twoWidths,
			     width,
			     runLength,
			     numSpacing,
			     spacings);
 ...
 * lefiOrthogonal
 */ lefiOrthogonal *
lefiOrthogonal_CreateUninitialized()
{
  lefiOrthogonal *this = (lefiOrthogonal *) malloc(sizeof(lefiOrthogonal));

  lefiOrthogonal_Init(this);
  return (this);
}

void 
lefiOrthogonal_Init(lefiOrthogonal * this)
{
  this->numAllocated_ = 0;
  this->numCutOrtho_ = 0;
  this->cutWithin_ = 0;
...
void
lefiOrthogonal_Delete(lefiOrthogonal * this)
{
  if (this == NULL)
    return;
  lefiOrthogonal_Destroy(this);
  free(this);
}

void 
lefiOrthogonal_Destroy(lefiOrthogonal * this)
{
  if (this->cutWithin_)
...
void 
lefiOrthogonal_addOrthogonal(lefiOrthogonal * this,
			     double cutWithin,
			     double ortho)
{
  int     i, len;
...
int 
lefiOrthogonal_numOrthogonal(const lefiOrthogonal * this)
{
  return this->numCutOrtho_;
}

double 
lefiOrthogonal_cutWithin(const lefiOrthogonal * this,
			 int index)
{
...
double 
lefiOrthogonal_orthoSpacing(const lefiOrthogonal * this,
			    int index)
{
  if (index < 0 || index >= this->numCutOrtho_)
    return 0;
...
lefiLayer_clear(lefiLayer * this)
{
  ...
  if (this->hasSpacingTableOrtho_) {
    lefiOrthogonal_Destroy(this->spacingTableOrtho_);
 ...
 * 5.8
 */ void 
lefiLayer_setLayerType(lefiLayer * this,
 ...
 * 5.7
 */ void 
lefiLayer_addMinimumcutWithin(lefiLayer * this,
			      double cutDistance)
{
 ...
 * 5.7
 */ void
lefiLayer_addMinstepMinAdjLength(lefiLayer * this,
                                 double adjLength)
{
 ...
 * 5.7
 */ void
lefiLayer_addMinstepMinBetLength(lefiLayer * this,
                                 double betLength)
{
 ...
 * 5.7
 */ void
lefiLayer_addMinstepXSameCorners(lefiLayer * this)
{
...
void 
lefiLayer_setSpacingLayerStack(lefiLayer * this)
{
 ...
 * 5.7
 */ void 
lefiLayer_setSpacingArea(lefiLayer * this,
			 double cutArea)
{
 ...
 * 5.7
 */ void 
lefiLayer_setSpacingAdjacentExcept(lefiLayer * this)
{
 ...
 * 5.7
 */ void 
lefiLayer_setSpacingSamenet(lefiLayer * this)
{
 ...
 * 5.7
 */ void 
lefiLayer_setSpacingSamenetPGonly(lefiLayer * this)
{
 ...
 * 5.7
 */ void 
lefiLayer_setSpacingNotchLength(lefiLayer * this,
				double notchLength)
{
 ...
 * 5.7
 */ void 
lefiLayer_setSpacingEndOfNotchWidth(lefiLayer * this,
				    double eonWidth,
				    double mnSpacing,
				    double eonLength)
{
 ...
 * 5.7
 */ void 
lefiLayer_setSpacingTableOrtho(lefiLayer * this)
{
  this->spacingTableOrtho_ = (lefiOrthogonal *) lefMalloc(sizeof(lefiOrthogonal));
  lefiOrthogonal_Init(this->spacingTableOrtho_);
}

/*
 * 5.7
 */ void 
lefiLayer_addSpacingTableOrthoWithin(lefiLayer * this,
				     double cutWithin,
				     double orthoSp)
{
  lefiOrthogonal_addOrthogonal(this->spacingTableOrtho_,
			       cutWithin,
			       orthoSp);
 ...
 * 5.7
 */ void 
lefiLayer_setArraySpacingLongArray(lefiLayer * this)
{
 ...
 * 5.7
 */ void 
lefiLayer_setArraySpacingWidth(lefiLayer * this,
			       double viaWidth)
{
 ...
 * 5.7
 */ void 
lefiLayer_setArraySpacingCut(lefiLayer * this,
			     double cutSpacing)
{
 ...
 * 5.7
 */ void 
lefiLayer_addArraySpacingArray(lefiLayer * this,
			       int arrayCut,
			       double arraySpacing)
{
  int     i, len;
 ...
 * 5.8
 */ int 
lefiLayer_hasLayerType(const lefiLayer * this)
{
  if (this->layerType_)
    return 1;
  return 0;
...
int 
lefiLayer_hasSpacingLayerStack(const lefiLayer * this,
			       int index)
{
  return ((this->hasSpacing_ != 0) && (this->hasSpacingLayerStack_[index] != 0)) ? 1 : 0;
}
 ...
 * 5.7
 */ int 
lefiLayer_hasSpacingArea(const lefiLayer * this,
			 int index)
{
  return ((this->hasSpacing_ != 0) && (this->hasSpacingCutArea_[index] != 0)) ? 1 : 0;
}
 ...
 * 5.7
 */ int 
lefiLayer_hasSpacingAdjacentExcept(const lefiLayer * this,
				   int index)
{
  return ((this->hasSpacing_ != 0) && (this->hasSpacingAdjacentExcept_[index] != 0)) ? 1 : 0;
}

/*
 * 5.7
 */ int 
lefiLayer_hasSpacingSamenet(const lefiLayer * this,
			    int index)
{
  return ((this->hasSpacing_ != 0) && (this->hasSpacingSamenet_[index] != 0)) ? 1 : 0;
}

/*
 * 5.7
 */ int 
lefiLayer_hasSpacingSamenetPGonly(const lefiLayer * this,
				  int index)
{
  return ((this->hasSpacing_ != 0) && (this->hasSpacingSamenetPGonly_[index] != 0)) ? 1 : 0;
}

/*
 * 5.7
 */ int 
lefiLayer_hasSpacingNotchLength(const lefiLayer * this,
				int index)
{
 ...
 * 5.7
 */ int 
lefiLayer_hasSpacingEndOfNotchWidth(const lefiLayer * this,
				    int index)
{
 ...
 * 5.7
 */ int 
lefiLayer_hasSpacingTableOrtho(const lefiLayer * this)
{
 ...
 * 5.8
 */ const char *
lefiLayer_layerType(const lefiLayer * this)
{
...
double 
lefiLayer_spacingArea(const lefiLayer * this,
		      int index)
{
 ...
 * 5.7
 */ double 
lefiLayer_spacingNotchLength(const lefiLayer * this,
			     int index)
{
 ...
 * 5.7
 */ double 
lefiLayer_spacingEndOfNotchWidth(const lefiLayer * this,
				 int index)
{
 ...
 * 5.7
 */ double 
lefiLayer_spacingEndOfNotchSpacing(const lefiLayer * this,
				   int index)
{
 ...
 * 5.7
 */ double 
lefiLayer_spacingEndOfNotchLength(const lefiLayer * this,
				  int index)
{
 ...
 * 5.7
 */ int 
lefiLayer_hasMinimumcutWithin(const lefiLayer * this,
			      int index)
{
 ...
 * 5.7
 */ double 
lefiLayer_minimumcutWithin(const lefiLayer * this,
			   int index)
{
...
void 
lefiLayer_addSpTwoWidths(lefiLayer * this,
			 double width,
			 double runLength)
{
  lefiSpacingTable *sp;
  ...
  sp = this->spacingTable_[this->numSpacingTable_ - 1];
  lefiSpacingTable_addTwoWidths(sp,
				width,
				runLength,
				this->numNums_,
				this->nums_);
...
void 
lefiLayer_addEnclosureExceptEC(lefiLayer * this,
			       double cutWithin)
{
...
void 
lefiLayer_addEnclosureLength(lefiLayer * this,
			     double minLength)
{
...
int 
lefiLayer_hasEnclosureExceptExtraCut(const lefiLayer * this,
				     int index)
{
...
double 
lefiLayer_enclosureExceptExtraCut(const lefiLayer * this,
				  int index)
{
  return this->cutWithin_[index];
}
...
int 
lefiLayer_hasEnclosureMinLength(const lefiLayer * this,
				int index)
{
...
double 
lefiLayer_enclosureMinLength(const lefiLayer * this,
			     int index)
{
 ...
 * 5.7
 */ int
lefiLayer_hasMinstepMinAdjLength(const lefiLayer * this,
                                 int index)
{
  char    msg[160];
 ...
 * 5.7
 */ double
lefiLayer_minstepMinAdjLength(const lefiLayer * this,
                              int index)
{
  char    msg[160];
 ...
 * 5.7
 */ int
lefiLayer_hasMinstepMinBetLength(const lefiLayer * this,
                                 int index)
{
  char    msg[160];
 ...
 * 5.7
 */ double
lefiLayer_minstepMinBetLength(const lefiLayer * this,
                              int index)
{
  char    msg[160];
 ...
 * 5.7
 */ int
lefiLayer_hasMinstepXSameCorners(const lefiLayer * this,
                                 int index)
{
  char    msg[160];
 ...
 * 5.7
 */ lefiOrthogonal *
lefiLayer_orthogonal(const lefiLayer * this)
{
...
/*
 * PRIVATE 5.7
 *//* SPACING cutSpacing *//* [CENTERTOCENTER] *//* [SAMENET] *//* [ LAYER
 * secondLayerName [STACK] *//* | ADJACENTCUTS {2|3|4} WITHIN cutWithin
 * [EXCEPTSAMEPGNET] *//* | PARALLELOVERLAP *//* | AREA cutArea ] ; *//* SPACI
 * NG routing ENDOFLINE eolWidth WITHIN eolWithin *//* [PARALLELEDGE parSpace
		       ...
		       int index)
{
  ...
  while (value) {
    ...
    spValue = atof(value);
    value = strtok(NULL, " ");
    if ((strcmp(value, "CENTERTOCENTER") == 0) || (strcmp(value, "SAMENET") == 0) || (strcmp(value, "LAYER") == 0) || (strcmp(value, "ADJACENTCUTS") == 0) || (strcmp(value, "PARALLELOVERLAP") == 0) || (strcmp(value, "AREA") == 0)) {
      if (strcmp(lefiLayer_type(this), "CUT") != 0) {
	sprintf(msg, "ERROR (LEFPARS-1321): The property LEF57_SPACING with value %s is for TYPE CUT only.\nThe current layer has the TYPE %s.\nUpdate the property of your lef file with the correct syntax or remove this property from your lef file.\n", this->values_[index], lefiLayer_type(this));
	lefiError(msg);
	free(wrkingStr);
	return;
      }
	...
	lefiLayer_setSpacingCenterToCenter(this);
	value = strtok(NULL, " ");
	if (*value == ';') {
          value = strtok(NULL, " ");
          continue;
	...
	lefiLayer_setSpacingSamenet(this);
	value = strtok(NULL, " ");
	if (*value == ';') {
          value = strtok(NULL, " ");
          continue;
	...
	if (value && *value != '\n') {
	  ...
	  if (strcmp(value, "STACK") == 0) {
        ...
        if (strcmp(value, "WITHIN") == 0) {
          value = strtok(NULL, " ");
          within = atof(value);
          lefiLayer_setSpacingAdjacent(this,
			               numCuts,
			               within);
          value = strtok(NULL, " ");
          if (strcmp(value, "EXCEPTSAMEPGNET") == 0) {
            lefiLayer_setSpacingAdjacentExcept(this);
            value = strtok(NULL, " ");
            if (*value != ';') {
              sprintf(msg, "ERROR (LEFPARS-1320): Incorrect syntax defined for property LEF57_SPACING with TYPE CUT: %s.\nCorrect syntax is \"SPACING cutSpacing [CENTERTOCENTER][SAMENET]\n\t[LAYER secondLayerName[STACK]\n\t| ADJACENTCUTS { 2 | 3 | 4 } WITHIN cutWithin[EXCEPTSAMEPGNET]\n\t| PARALLELOVERLAP\n\t| AREA cutArea ;\"", this->values_[index]);
              lefiError(msg);
      ...
      if (strcmp(lefiLayer_type(this), "ROUTING") != 0) {
...
/*
 * PRIVATE 5.7
 *//* NOT an OA data model void lefiLayer::parseMaxFloating(int index) { char
 * *wrkingStr = strdup(this->values_[index]); char   *value; double maxArea;
 * char   msg[1024];
 * 
 * value = strtok(wrkingStr, " "); if (strcmp(value, "MAXFLOATINGAREA") != 0) {
 * sprintf(msg, "ERROR (LEFPARS-1306): Incorrect syntax defined for property
 * LEF57_MAXFLOATINGAREA: %s.\nCorrect syntax is \"MAXFLOATINGAREA
 * maxArea\"\n", this->values_[index]); lefiError(msg); free(wrkingStr);
 * return; }
 * 
 * value = strtok(NULL, " "); maxArea = atof(value);
 * this->lefiLayer::setMaxFloatingArea(maxArea);
 * 
 * free(wrkingStr); return; } */
			    ...
			    int index)
{
  ...
  while (strcmp(value, ";") != 0) {
    if (strcmp(value, "LONGARRAY") == 0) {
      ...
      if (hasLongArray)
        lefiLayer_setArraySpacingLongArray(this);
      lefiLayer_setArraySpacingWidth(this,
				     viaWidth);
      lefiLayer_setArraySpacingCut(this,
				   cutSpacing);
      value = strtok(NULL, " ");
      ...
      lefiLayer_addArraySpacingArray(this,
				     arrayCuts,
				     arraySpacing);
      value = strtok(NULL, " ");
      hasArrayCut = 1;
...
/*
 * PRIVATE 5.7
 *//* MINSTEP minStepLength *//* [MAXEDGES maxEdges] ; *//* Save the value first to make sure the syntax that is supported by the parser */ void 
		       ...
		       int index)
{
  ...
  /* lefiLayer_addMinstep(this, minStepLength); */
  value = strtok(NULL, " ");
  while (done == 0) {
    if (value && *value != '\n') {
      if (strcmp(value, "MAXEDGES") == 0) {
        ...
        value = strtok(NULL, " ");
        maxEdges = atoi(value);
        /* lefiLayer_addMinstepMaxedges(this, maxEdges); */
        value = strtok(NULL, " ");
        ...
        /* lefiLayer_addMinstepMinAdjLength(minAdjLength); */
        value = strtok(NULL, " ");
        ...
        /* lefiLayer_addMinstepMinBetLength(minBetLength); */
        value = strtok(NULL, " ");
      } else if (strcmp(value, "EXCEPTSAMECORNERS") == 0) {
        if (minBetLength) {
           xSameCorners = 1;
           /* lefiLayer_addMinstepXSameCorners(); */
           value = strtok(NULL, " ");
        } else {
          sprintf(msg, "ERROR (LEFPARS-1315): Incorrect syntax defined for property LEF57_MINSTEP: %s\nCorrect syntax is \"MINSTEP minStepLength [MAXEDGES maxEdges] [MINADJACENTLENGTH minAdjLength | MINBETWEENLENGTH minBetweenLength [EXCEPTSAMECORNERS]] ;\"\n", this->values_[index]);
          lefiError(msg);
  ...
  if (maxEdges)
    lefiLayer_addMinstepMaxedges(this, maxEdges);
  if (minAdjLength)
    lefiLayer_addMinstepMinAdjLength(this, minAdjLength);
  if (minBetLength)
    lefiLayer_addMinstepMinBetLength(this, minBetLength);
  if (xSameCorners)
    lefiLayer_addMinstepXSameCorners(this);
  free(wrkingStr);
  return; 
}
 ...
 *//* [ENCLOSURE [ABOVE | BELOW] overhang1 overhang2 *//* [WIDTH minWidth
    [EXCEPTEXTRACUT cutWithin] *//* |LENGTH minLength] ; */ void 
lefiLayer_parseLayerEnclosure(lefiLayer * this,
			      int index)
{
  char   *wrkingStr = strdup(this->values_[index]);
  char   *value;
  ...
  while (strcmp(value, ";") != 0) {
    ...
    value = strtok(NULL, " ");
    width = 1;
    if (strcmp(value, "EXCEPTEXTRACUT") == 0) {
      except = 1;
      value = strtok(NULL, " ");
...
{
lefiLayer_addEnclosure(this,
		       enclRule,
		       overhang1,
		       overhang2);
if (width) {
  lefiLayer_addEnclosureWidth(this,
			      minWidth);
  if (except)
    lefiLayer_addEnclosureExceptEC(this,
				   cutWithin);
}
if (length)
  lefiLayer_addEnclosureLength(this,
			       minLength);
}
...
lefiLayer_parse65nmRules(lefiLayer * this)
{
  ...
  for (i = 0;
	...
	else if (strcmp(this->names_[i], "LEF57_ENCLOSURE") == 0) {
	  lefiLayer_parseLayerEnclosure(this,
					i);
	}
      }
    }
 ...
 * PRIVATE 5.8
 */ void 
lefiLayer_parseLayerType(lefiLayer * this,
			 int index)
{
  char   *wrkingStr = strdup(this->values_[index]);
  char   *value;
  ...
  if ((strcmp(value, "POLYROUTING") == 0) || (strcmp(value, "MIMCAP") == 0)) {
    if (strcmp(this->type_, "ROUTING") == 0)
      lefiLayer_setLayerType(this, value);
    else {
  ...
  else if ((strcmp(value, "TSV") == 0) || (strcmp(value, "PASSIVATION") == 0)) {
...
/*
 * 5.8
 *//* This API will is created just for OA to call in 5.7 only. *//* This API
 * will be obsoleted once 5.8 APIs are available and OA moves *//* to using
 * them. *//* It will look for the properties in "this" that are type 'S' and *//* p
    roperty name is "LEF58_TYPE" */ void 
lefiLayer_parseLEF58Layer(lefiLayer * this)
{
  int     i;
