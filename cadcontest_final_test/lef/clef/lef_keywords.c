...
lef_init_symbol_table(void *Keyword_set)
{
  ...
  lef_add_to_stringtab_Int(Keyword_set, "ENDOFNOTCHWIDTH",
			   K_ENDOFNOTCHWIDTH);
  ...
  lef_add_to_stringtab_Int(Keyword_set, "EXCEPTSAMEPGNET",
			   K_EXCEPTSAMEPGNET);
  ...
  lef_add_to_stringtab_Int(Keyword_set, "PARALLELOVERLAP",
			   K_PARALLELOVERLAP);
