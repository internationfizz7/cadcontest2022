 ...
 * re set, the defwriter will call the user callback functions when *//* it
 ...
 * and on the output file if there is one. *//* Def writer provides default
 * callback routines for some but not all *//* required sections. *//* Section
 * s the writer provides default callbacks are: *//* Version -- default to
 * 5.3 *//* NamesCaseSensitive -- default to OFF *//* BusBitChars -- default
 * to "[]" *//* DividerChar -- default to "/"; // *//* Author: Wanda da Rosa *//* D
 * ate:   05/14/99 *//* Revisions: */
 ...
 *//* These are filled in by the user.  See the *//* "set" routines at the end
    of the file *//* The callback routines */ defwVoidCbkFnType defwCallbacksSeq[MAXCBS] = {0, /* defwVersionCbk */ 0, /* defwCaseSensitiveCbk */ 0, /* defwDividerCbk */ 0, /* defwBusBitCbk */ 0, /* defwDesignCbk */ 0, /* defwTechCbk */ 0, /* defwArrayCbk */ 0, /* defwFloorPlanCbk */ 0, /* defwUnitsCbk */ 0, /* defwHistoryCbk */ 0, /* defwPropDefCbk */ 0, /* defwDieAreaCbk */ 0, /* defwRowCbk */ 0, /* defwTrackCbk */ 0, /* defwGcellGridCbk */ 0, /* defwDefaultCapCbk */ 0, /* defwCanplaceCbk */ 0, /* defwCannotOccupyCbk */ 0, /* defwViaCbk */ 0, /* defwRegionCbk */ 0, /* defwComponentCbk */ 0, /* defwPinCbk */ 0, /* defwPinPropCbk */ 0, /* defwSNetCbk */ 0, /* defwNetCbk */ 0, /* defwIOTimingCbk */ 0, /* defwScanchainCbk */ 0, /* defwConstraintCbk */ 0,	/* defwAssertionCbk pre
      5.2 */ 0, /* defwGroupCbk */ 0, /* defwBlockageCbk 5.4 */ 0, /* defwExtCbk */ 0,	/* defwDesignEndCbk *//* A
    dd NEW CALLBACK here */ };

/*
 * the optional and required callbacks and
 *//* if default routines are available */ int defwCallbacksReq[MAXCBS][2] = {{0, 0}, /* Version */ {0, 0}, /* CaseSensitive */ {0, 0}, /* Divider */ {0, 0}, /* BusBit */ {1, 0}, /* Design */ {0, 0}, /* Tech */ {0, 0}, /* Array */ {0, 0}, /* FloorPlan */ {0, 0}, /* Units */ {0, 0}, /* History */ {0, 0}, /* PropDef */ {0, 0}, /* DieArea */ {0, 0}, /* Row */ {0, 0}, /* Track */ {0, 0}, /* GcellGrid */ {0, 0}, /* DefaultCap */ {0, 0}, /* Canplace */ {0, 0}, /* CannotOccupy */ {0, 0}, /* Via */ {0, 0}, /* Region */ {0, 0}, /* Component */ {0, 0}, /* Pin */ {0, 0}, /* PinProp */ {0, 0}, /* SNet */ {0, 0}, /* Net */ {0, 0}, /* IOTiming */ {0, 0}, /* Scanchain */ {0, 0}, /* Constraint */ {0, 0}, /* Assertion pre 5.2 */ {0, 0}, /* Group */ {0, 0}, /* Blockage */ {0, 0}, /* Ext */ {1, 0},	/* DesignEnd *//* Add
    NEW CALLBACK here */ };
 ...
 */ defwCallbackType_e defwCallbacksType[MAXCBS] = {defwVersionCbkType,
  ...
  defwAssertionCbkType, /* pre 5.2 */ defwGroupCbkType,
  defwBlockageCbkType, /* 5.4 */ defwExtCbkType,
...
int 
defwWrite(FILE * f, const char *fName, defiUserData uData)
{
  int     i;
...
void 
defwSetUnusedCallbacks(defwVoidCbkFnType func)
{
...
int 
defwCountFunc(defwCallbackType_e e, defiUserData d)
{
  int     i = (int) e;
...
void 
defwPrintUnusedCallbacks(FILE * f)
{
  int     i;
...
void 
defwSetUserData(defiUserData d)
{
  defwUserData = d;
}
...
void 
defwSetArrayCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwArrayCbk] = f;
}

void 
defwSetAssertionCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwAssertionCbk] = f;
}

void 
defwSetBlockageCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwBlockageCbk] = f;
}

void 
defwSetBusBitCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwBusBitCbk] = f;
}

void 
defwSetCannotOccupyCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwCannotOccupyCbk] = f;
}

void 
defwSetCanplaceCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwCanplaceCbk] = f;
}

void 
defwSetCaseSensitiveCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwCaseSensitiveCbk] = f;
}

void 
defwSetComponentCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwComponentCbk] = f;
}

void 
defwSetConstraintCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwConstraintCbk] = f;
}

void 
defwSetDefaultCapCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwDefaultCapCbk] = f;
}

void 
defwSetDesignCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwDesignCbk] = f;
}

void 
defwSetDesignEndCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwDesignEndCbk] = f;
}

void 
defwSetDieAreaCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwDieAreaCbk] = f;
}

void 
defwSetDividerCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwDividerCbk] = f;
}

void 
defwSetExtCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwExtCbk] = f;
}

void 
defwSetFloorPlanCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwFloorPlanCbk] = f;
}

void 
defwSetGcellGridCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwGcellGridCbk] = f;
}

void 
defwSetGroupCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwGroupCbk] = f;
}

void 
defwSetHistoryCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwHistoryCbk] = f;
}

void 
defwSetIOTimingCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwIOTimingCbk] = f;
}

void 
defwSetNetCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwNetCbk] = f;
}

void 
defwSetPinCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwPinCbk] = f;
}

void 
defwSetPinPropCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwPinPropCbk] = f;
}

void 
defwSetPropDefCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwPropDefCbk] = f;
}

void 
defwSetRegionCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwRegionCbk] = f;
}

void 
defwSetRowCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwRowCbk] = f;
}

void 
defwSetSNetCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwSNetCbk] = f;
}

void 
defwSetScanchainCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwScanchainCbk] = f;
}

void 
defwSetTechnologyCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwTechCbk] = f;
}

void 
defwSetTrackCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwTrackCbk] = f;
}

void 
defwSetUnitsCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwUnitsCbk] = f;
}

void 
defwSetVersionCbk(defwVoidCbkFnType f)
{
  defwCallbacksSeq[defwVersionCbk] = f;
}

void 
defwSetViaCbk(defwVoidCbkFnType f)
{
 ...
 */
void 
defwSetLogFunction(DEFI_LOG_FUNCTION f)
{
  defiErrorLogFunction = f;
}

void 
defwSetWarningLogFunction(DEFI_WARNING_LOG_FUNCTION f)
{
